...
def process_cwp():
    ...
    try:
        ...
        print("The mean of the nonlinear z-scores for coupled wiener processes regarding causality from X to Y after {} experiments is {:.2f}.".format(num_exp, z_mean_nonlinear))
        print("The mean of the linear z-scores for coupled wiener processes regarding causality from Y to X after {} experiments is {:.2f}.".format(num_exp, z_mean_lin_rev))
        print("The mean of the nonlinear z-scores for coupled wiener processes regarding causality from Y to X after {} experiments is {:.2f}.".format(num_exp, z_mean_nonlin_rev))
